...
class CreateItemRequest(BaseModel):
    tipo_inventario_id: int = Field(ge=1, description="ID del tipo de inventario al que pertenece el item")
    ...
    estado_objeto: str = Field(min_length=2, max_length=100, description="Estado del objeto")
