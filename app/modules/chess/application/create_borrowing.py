...
from app.modules.chess.schemas.request import CreateChessBorrowRequest

class CreateChessBorrowing:
    ...
    async def execute(self, data: CreateChessBorrowRequest):
        return await self.service.create_chess_borrow(data)
